...
<?php } ?>
		...
		<table border="0" cellpadding="0" cellspacing="0" width="100%" style="">
		        ...
		        <?php
					...
					$user_select_query1="select * from ".TABLE_POST." where id='".(int)$_GET['location']."' OR contact_city='".$_GET['location']."' OR contact_state='".$_GET['location']."' OR contact_zip_code='".(int)$_GET['location']."'ORDER by id DESC "; 
					} else {
					$user_select_query1="select * from ".TABLE_POST." where copy =0 AND deleted=0 ORDER by id DESC ";
					}
				...
				?>
				<tr>
					<td><a target="_blank" href="../property.php?id=<?php echo $user_select_rows1['id']; ?>"><img src="../photos/<?php if(file_exists("../photos/".$user_select_rows1['id'].".jpg")) echo $user_select_rows1['id']; else echo "default"; ?>.jpg" style="border:2px solid #ccc;" width="100px" height="65px" /></a></td>
						<td>
						  <?php echo $user_select_rows1['contact_state']; ?>, <?php echo $user_select_rows1['contact_city']; ?>, <?php echo $user_select_rows1['contact_zip_code']; ?>
						</td>
						<td>
						  <?php echo $user_select_rows1['id']; ?>
						</td>
						<td>
				<strong><a href="../property.php?id=<?php echo $user_select_rows1['id']; ?>"><?php $t=$user_select_rows1['type']; echo $typename[$t]; ?></a></strong>
		...
		<?php } else { ?>
			<table border="0" cellpadding="0" cellspacing="0" width="100%" style="">
				<?php
					if(isset($_GET['location']) && ($_GET['action']=='Search')) {
					$user_select_query="select * from ".TABLE_POST." where id='".(int)$_GET['location']."' OR contact_city='".$_GET['location']."' OR contact_state='".$_GET['location']."' OR contact_zip_code='".(int)$_GET['location']."'ORDER by id DESC "; 
					} else {
					$user_select_query="select * from ".TABLE_POST." where copy =0 AND deleted=0 AND category ='Shared Apt-Homes' ORDER by id DESC ";
					}
				...
				?>
				<tr>
					<td><a target="_blank" href="../property.php?id=<?php echo $user_select_rows['id']; ?>"><img src="../photos/<?php if(file_exists("../photos/".$user_select_rows['id'].".jpg")) echo $user_select_rows['id']; else echo "default"; ?>.jpg" style="border:2px solid #ccc;" width="100px" height="65px" /></a></td>
						<td>
						  <?php echo $user_select_rows['contact_state']; ?>, <?php echo $user_select_rows['contact_city']; ?>, <?php echo $user_select_rows['contact_zip_code']; ?>
						</td>
						<td>
						  <?php echo $user_select_rows['id']; ?>
						</td>
						<td>
					<strong><a href="../property.php?id=<?php echo $user_select_rows['id']; ?>"><?php $t=$user_select_rows['type']; echo $typename[$t]; ?></a></strong>
