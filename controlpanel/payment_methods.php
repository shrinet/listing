<?php defined('ACCESS_SUBFILES') or die('Restricted access');
			...
			$page_url="index.php?p=payment_methods";

			$page_url2="index.php?p=payment_methods";	
...
<fieldset>
	...
	<span class="small_input"><input class="small" name="payment_method" type="text" value="<?php echo htmlentities($data['payment_method']);?>" /></span><br class="hid" />
	<label>Card Logo :</label>

	<span><input name="card_logo" type="file" value="<?php echo $data['card_logo'];?>" /></span><br class="hid" />
...
<div class="box">
	...
	<table border="0" cellpadding="0" cellspacing="0" style="width:720px;">
		...
		<?php			
			...
			$catg_select_query="SELECT * FROM ".TABLE_PAYMENT_METHODS." ORDER BY id";
		...
		<tr>
			...
			<th class="col2">Card Type</th>
			<th class="col2">Card Logo</th>
...
<?php	
		...
		<tr >
			...
			<td><?php echo stripslashes($catg_select_rows['payment_method']);?></td>
			<td><img src="../payment_methods/<?php echo stripslashes($catg_select_rows['id']);?>.jpg" width="100px" height="60px" /></td>
		  	<td class="action">
